...
if __name__ == "__main__":
   ...
   h_b = 8e-2  # heights of bar profile  [m]
   b_b = 8e-2  # width of bar profile  [m]
   ...
   # # highlight thick bars
   # plt.subplot(projection='3d')
   # fem.plot(nodes, bars[myCrane.thick_bars], 'lightskyblue', '-', 2, lg='thick bars')          
   # plt.show()