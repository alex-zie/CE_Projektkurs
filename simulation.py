...
if __name__ == "__main__":
    ...
    g = 9.81  # m/s^2
    myCrane = crane(1, 6, 6, 1, 1, A, rho, E)
    nodes = myCrane.nodes
    bars = myCrane.bars
    fem = FEM(myCrane)
    #for i in range(-1, -5, -1):
    #    myCrane.addExternalForce(i, 0, 0, -50e4)
    #fem.addWind(28, 1, 1)
    N, R, U = fem.TrussAnalysis(True)
    ...
    fem.Plot(Dnodes, bars[myCrane.y_side], 'yellow', '-', 2, 'Selected bars Y')
    fem.Plot(Dnodes, bars[myCrane.x_side], 'green', '-', 2, 'Selected bars X')
